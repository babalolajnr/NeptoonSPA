  ...
  <div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="home" class="brand-link">
        <img
          src="images/neptune2Favicon.png"
          alt="Neptune logo"
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <span
              v-b-hover="usernameHover"
              :class="isHovered ? 'text-danger' : ''"
        ...
        <nav class="mt-2">
          ...
          >
            ...
            <li class="nav-item has-treeview">
              ...
              <a
                href="#"
                :class="currentRoute !== 'addnewpost' ? '' : 'active'"
                class="nav-link"
              >
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <router-link
                    to="/drafts"
                    :class="currentRoute !== 'drafts' ? '' : 'active'"
                    class="nav-link"
                  >
                ...
                <li class="nav-item">
                  <router-link
                    to="/liveposts"
                    :class="currentRoute !== 'liveposts' ? '' : 'active'"
                    class="nav-link"
                  >
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <router-link
                    to="/addnewcategory"
                    :class="currentRoute !== 'addnewcategory' ? '' : 'active'"
                    class="nav-link"
                  >
                ...
                <li class="nav-item">
                  <a
                    href="#"
                    class="nav-link"
                    :class="currentRoute !== 'viewcategories' ? '' : 'active'"
                  >
